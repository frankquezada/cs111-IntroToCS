...
public class DefectiveFrankAnswer // name of program
{
	//-----------------------
	...
	public static void main(String [] args)
	{
		...
		float split; // split = # of people splitting bill (ONE-logic)
		int bill, tip, newtip, newbill, splitbill; 
		/* bill      = bill amount (TWO-logic)
		   tip       = tip percentage
		...
		*/
		...
		cname = scan.nextString(); // (THREE-syntax)
		...
		newtip = bill * tip/100.0;	// tip calculation (FOUR-logic)
		...
		split = scan.nextint(); // (FIVE-Syntax)
